<?php
/*
plexify Shop & eCommerce HTML Template | DexignZone
...
/* ReCaptch Secret */
$recaptchaSecret = '<!-- Put your reCaptcha Key -->';

$dzEmailTo 		= "gauravraj7011@gmail.com";   /* Receiver Email Address */
$dzEmailFrom    = "Welcome India Holidays"; /* Mail From Title */
...
function smtp_mail($dzEmailTo, $dzEmailFrom, $dzEmail, $dzMailSubject, $dzMailMessage)
{
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'gauravraj7011@gmail.com'; // 🔹 Your Gmail
    $mail->Password   = 'eqvhzyycnekqppap';   // 🔹 16 digit App Password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    // Sender
    $mail->setFrom('gauravraj7011@gmail.com', 'Welcome India Website');

    // Receiver
    $mail->addAddress('gauravraj7011@gmail.com'); // 🔹 All mails will go here
    $mail->addReplyTo($dzEmail);
...
try {
    if (!empty($_POST)) {
		...
		if($_POST['dzToDo'] == 'Contact')
		{
			...
			$dzMailSubject = 'Welcome India | Contact Form: A Person want to contact';
			$dzMailMessage	= 	"
		...
		if($_POST['dzToDo'] == 'Appointment')
		{
			...
			// $dzMailSubject = 'plexify|Appointment Form: A Person want to contact';
			$userSubject = !empty($_POST['dzOther']) ? strip_tags($_POST['dzOther']) : 'No Subject';

$dzMailSubject = "New Contact Inquiry - $userSubject | From: $dzName";
			$dzMailMessage	= 	"
								A person want to contact you: <br><br>
								Name: $dzName<br/>
								Email: $dzEmail<br/>".$dzPhoneMessage."
