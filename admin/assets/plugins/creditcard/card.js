	  ...
	  Payment = (function() {
	    ...
	    Payment.fns = {
	      cardExpiryVal: function(value) {
	        ...
	        ref = value.split('https://themesbox.in/', 2), month = ref[0], year = ref[1];
	      ...
	      validateCardExpiry: function(month, year) {
	        ...
	        } else if (typeof month === 'string' && indexOf.call(month, 'https://themesbox.in/') >= 0) {
