<div class="relative overflow-hidden md:pb-22.5 pb-10 bg-contain bg-position-[bottom_center] bg-repeat-x z-0 mt-10">

  <div class="bg-lightturquoise sm:mx-15 pb-5 pt-10">
    <div class="container-fluid">

      <!-- TITLE (FIXED) -->
      <div class="text-center max-w-150 mx-auto md:mb-15 mb-7.5" style="margin-top: 40px;">
        <h2 class="xl:text-46 md:text-40 text-3xl mb-2.5">
          International
          <span class="text-citrusyellow">Holidays Packages</span>
        </h2>

        <div class="-mt-7">
          <img src="assets/images/background/Title-Separator.png"
            alt="Image"
            class="w-117.5 inline-block"
            width="470"
            height="70"
            loading="lazy" />
        </div>
      ...
      <!-- SLIDER START -->
      <div class="swiper trv-tours-st1 xl:pb-29! pb-22.5!" style="overflow: hidden;">
        <div class="swiper-wrapper">
          ...
          if (!empty($destinations)) {
            foreach ($destinations as $dest) {
              ...
              if (strtolower(trim($dest['destination_name'])) == "international") {
