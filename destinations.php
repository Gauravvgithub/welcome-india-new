              ...
              <div class="container-fluid">
                ...
                <div class="subcategory-grid">
                  ...
                  ?>
                      ...
                      <?php
                      // Destination ka naam check karo
                      $dest_name = strtolower(trim($category['destination_name']));
                      $sub_package_dests = ['india tour package', 'customize packages'];

                      if (in_array($dest_name, $sub_package_dests)) {
                        $link = "sub-packege.php?id=" . $subcat['id'];
                      } else {
                        $link = "sub-packege.php?id=" . $subcat['id'];
                      }
                      ?>
                      <a href="<?php echo $link; ?>" class="subcat-card block group">
                        <div class="rounded-3xl overflow-hidden shadow-[0px_18px_18px_rgba(0,106,114,0.15)] bg-white">
                          ...
                          <!-- Name Section -->
                          <div class="py-5 px-6 flex items-center justify-between" style="px-6">
